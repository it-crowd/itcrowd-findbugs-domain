...
import static pl.itcrowd.findbugs.domain.Annotations.JAVAX_PERSISTENCE_COLUMN_ATTRIBUTE_LENGTH;
import static pl.itcrowd.findbugs.domain.Annotations.JAVAX_PERSISTENCE_COLUMN_ATTRIBUTE_NAME;
import static pl.itcrowd.findbugs.domain.Annotations.JAVAX_PERSISTENCE_COLUMN_ATTRIBUTE_NULLABLE;
import static pl.itcrowd.findbugs.domain.Annotations.JAVAX_PERSISTENCE_COLUMN_DEFAULT_LENGTH;
import static pl.itcrowd.findbugs.domain.Annotations.JAVAX_PERSISTENCE_COLUMN_DEFAULT_NULLABLE;
import static pl.itcrowd.findbugs.domain.Annotations.JAVAX_PERSISTENCE_ENTITY;
import static pl.itcrowd.findbugs.domain.Annotations.JAVAX_PERSISTENCE_ID;
import static pl.itcrowd.findbugs.domain.Annotations.JAVAX_PERSISTENCE_JOIN_COLUMN;
import static pl.itcrowd.findbugs.domain.Annotations.JAVAX_PERSISTENCE_JOIN_TABLE;
import static pl.itcrowd.findbugs.domain.Annotations.JAVAX_PERSISTENCE_JOIN_TABLE_ATTRIBUTE_INVERSE_JOIN_COLUMNS;
import static pl.itcrowd.findbugs.domain.Annotations.JAVAX_PERSISTENCE_JOIN_TABLE_ATTRIBUTE_JOIN_COLUMNS;
import static pl.itcrowd.findbugs.domain.Annotations.JAVAX_PERSISTENCE_JOIN_TABLE_ATTRIBUTE_NAME;
import static pl.itcrowd.findbugs.domain.Annotations.JAVAX_PERSISTENCE_MANY_TO_ONE;
import static pl.itcrowd.findbugs.domain.Annotations.JAVAX_PERSISTENCE_MANY_TO_ONE_ATTRIBUTE_OPTIONAL;
import static pl.itcrowd.findbugs.domain.Annotations.JAVAX_PERSISTENCE_MANY_TO_ONE_DEFAULT_OPTIONAL;
import static pl.itcrowd.findbugs.domain.Annotations.JAVAX_PERSISTENCE_TABLE;
import static pl.itcrowd.findbugs.domain.Annotations.JAVAX_VALIDATION_CONSTRAINTS_NOT_EMPTY;
import static pl.itcrowd.findbugs.domain.Annotations.JAVAX_VALIDATION_CONSTRAINTS_NOT_NULL;
import static pl.itcrowd.findbugs.domain.Annotations.JAVAX_VALIDATION_CONSTRAINTS_SIZE;
import static pl.itcrowd.findbugs.domain.Annotations.JAVAX_VALIDATION_CONSTRAINTS_SIZE_ATTRIBUTE_MAX;
import static pl.itcrowd.findbugs.domain.Annotations.JAVAX_VALIDATION_CONSTRAINTS_SIZE_DEFAULT_MAX;
...
import static pl.itcrowd.findbugs.domain.BcelHelper.getType;
import static pl.itcrowd.findbugs.domain.BcelHelper.isArray;
import static pl.itcrowd.findbugs.domain.BcelHelper.isCollection;
import static pl.itcrowd.findbugs.domain.BcelHelper.isJavaxPersistenceColumnOrJoinColumn;
import static pl.itcrowd.findbugs.domain.BcelHelper.isMap;
import static pl.itcrowd.findbugs.domain.BcelHelper.isSingleValue;
import static pl.itcrowd.findbugs.domain.BcelHelper.isString;
