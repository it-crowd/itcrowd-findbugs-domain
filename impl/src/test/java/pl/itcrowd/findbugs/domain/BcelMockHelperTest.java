...
//        Then
    ...
    {
//        Given
        final Field fieldA = BcelMockHelper.mockField(TypeStrings.JAVA_LANG_STRING);
        final String expectedAnnotaionType = TypeStrings.ORG_JUNIT_TEST;
        final String expectedAnnotaionType2 = JAVAX_PERSISTENCE_COLUMN;
        final Field fieldB = BcelMockHelper.mockField(TypeStrings.JAVA_UTIL_COLLECTION,
